...
const premiumItems = [
  ...
  { icon: "⭐", title: "내 인생의 황금기, 아직 남았을까?", price: "2,900원", desc: "대운 흐름으로 보는 인생 전환점", sku: "saju_peaklife" },
  { icon: "🏖️", title: "은퇴 후 삶, 어떻게 보내면 좋을까?", price: "2,900원", desc: "은퇴 시기와 노후 생활 방향", sku: "saju_retirement" },
  { icon: "💼", title: "제2의 직업, 나에게 맞을까?", price: "2,900원", desc: "전직/부업 적성과 시기 분석", sku: "saju_career2" },
  { icon: "👨‍👩‍👧‍👦", title: "가족 간 갈등, 언제쯤 풀릴까?", price: "2,900원", desc: "가족 관계 개선 시기와 방향", sku: "saju_family" },
  { icon: "🏪", title: "소소하게 가게라도 해볼까? 창업운", price: "2,900원", desc: "창업 적성, 시기, 업종 분석", sku: "saju_business" },
  { icon: "🏠", title: "이사/매매, 지금 움직여도 될까요?", price: "2,900원", desc: "이사 방위와 부동산 매매 시기", sku: "saju_realestate" },
];
