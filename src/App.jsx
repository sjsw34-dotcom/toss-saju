...
##사주구조분석##
일간 ${ilgan}(${ilganElem})의 강약과 월령 득령 여부, 오행 분포(${elemStr}) 전체를 분석하세요.
용신(用神)과 기신(忌神)이 무엇인지 명확히 짚고, 이 사주 구조가 [${itemTitle}] 주제와 구체적으로 어떻게 연결되는지 서술하세요.
이 사람만의 사주 특징을 충분히 설명하여 500자 이상 작성하세요.

##핵심운세풀이##
[${itemTitle}] 주제에 대해 이 사주가 가진 강점과 주의할 점을 오행 상생상극 원리로 구체적으로 분석하세요.
일간 ${ilgan}, 오행 분포 ${elemStr}에서 비롯된 이 사람만의 특징을 실질적으로 서술하고,
추상적 표현 없이 구체적 상황과 사례 중심으로 500자 이상 작성하세요.

##시기분석##
${thisYear}년 ${yearStem}${yearBranch}년 세운이 이 사주에 미치는 영향을 상세히 분석하세요.
${thisYear+1}년, ${thisYear+2}년의 대운·세운 흐름도 서술하고,
유리한 달과 주의할 달을 최대한 구체적으로 언급하여 500자 이상 작성하세요.

##실천조언##
이 사주의 용신을 바탕으로 [${itemTitle}]와 관련한 실생활 행동 지침을 제시하세요.
행운의 색상·방향, 피해야 할 것, 지금 당장 할 수 있는 것을 구체적으로 적고
희망적인 마무리 문장으로 끝내세요. 400자 이상 작성하세요.
