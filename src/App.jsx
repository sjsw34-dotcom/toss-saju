...
##사주구조분석##
일간 ${ilgan}의 강약(득령 여부), 오행 분포(${elemStr}), 용신·기신을 밝히고 [${itemTitle}]와의 연결점을 서술하세요. 300자 내외로 핵심만 압축하여 완성하세요.

##핵심운세풀이##
[${itemTitle}] 주제에서 이 사주(일간 ${ilgan}, ${elemStr})의 강점과 주의점을 오행 원리로 분석하세요. 300자 내외로 핵심만 압축하여 완성하세요.

##시기분석##
${thisYear}년 ${yearStem}${yearBranch}년 세운이 이 사주에 미치는 영향을 분석하고, ${thisYear+1}~${thisYear+2}년 흐름과 유리한 달·주의할 달을 언급하세요. 300자 내외로 핵심만 압축하여 완성하세요.

##실천조언##
용신 기반의 실생활 조언(색상·방향·행동지침)을 제시하고 희망적인 마무리 문장으로 끝내세요. 250자 내외로 핵심만 압축하여 완성하세요.

[필수 준수사항]
- 한국어 존댓말, 자연스러운 문단 형식
- 실제 만세력 수치 인용 (추상적 일반론 금지)
- 구분자(##...##) 외 특수기호·별표·대시 사용 금지
- 4개 섹션 모두 반드시 완성할 것 — 길이보다 완성이 우선`;
